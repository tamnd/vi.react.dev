---
title: Các phiên bản React
---

<Intro>

Tài liệu React tại [react.dev](https://react.dev) cung cấp tài liệu cho phiên bản React mới nhất.

</Intro>

Chúng tôi muốn giữ tài liệu được cập nhật trong phạm vi từng phiên bản major, và không phát hành một phiên bản tài liệu riêng cho từng phiên bản minor hoặc patch. Khi một phiên bản major mới được phát hành, chúng tôi lưu trữ tài liệu của phiên bản trước đó dưới dạng `x.react.dev`. Hãy xem [chính sách tạo phiên bản](/community/versioning-policy) của chúng tôi để biết thêm chi tiết.

Bạn có thể tìm thấy kho lưu trữ của các phiên bản major trước đây ở bên dưới.

## Phiên bản mới nhất: 19.2 {/*latest-version*/}
...
#### Tài liệu cũ {/*legacy-docs*/}

Vào năm 2023, chúng tôi [ra mắt bộ tài liệu mới](/blog/2023/03/16/introducing-react-dev) cho React 18 dưới tên [react.dev](https://react.dev). Bộ tài liệu React 18 cũ hiện có tại [legacy.reactjs.org](https://legacy.reactjs.org). Các phiên bản 17 trở xuống được lưu trữ trên các trang legacy.

Với các phiên bản cũ hơn React 15, hãy xem [15.react.dev](https://15.react.dev).
...
### React 0.10 trở xuống {/*react-10-and-below*/}
...
### Commit đầu tiên {/*initial-commit*/}

React được mở mã nguồn vào ngày 29 tháng 5 năm 2013. Commit đầu tiên là: [`75897c`: Initial public release](https://github.com/facebook/react/commit/75897c2dcd1dd3a6ca46284dd37e13d22b4b16b4)

Hãy xem bài blog đầu tiên: [Why did we build React?](https://legacy.reactjs.org/blog/2013/06/05/why-react.html)

React đã được mở mã nguồn tại Facebook Seattle vào năm 2013:
