...
React ban đầu được tạo ra bởi [Jordan Walke](https://github.com/jordwalke). Ngày nay, React có một [đội ngũ chuyên trách toàn thời gian](/community/team) làm việc trên dự án này, cùng với hơn một nghìn [người đóng góp mã nguồn mở](https://github.com/facebook/react/graphs/contributors).

</Intro>

## Những người đóng góp trước đây {/*past-contributors*/}

Chúng tôi muốn ghi nhận một số người đã có những đóng góp quan trọng cho React và tài liệu của nó trong quá khứ, đồng thời đã giúp duy trì chúng qua nhiều năm:
...
Chúng tôi muốn gửi lời cảm ơn đặc biệt đến [Tom Occhino](https://github.com/tomocchino) và [Adam Wolff](https://github.com/wolffiex) vì sự hướng dẫn và hỗ trợ của họ trong suốt nhiều năm. Chúng tôi cũng biết ơn tất cả những tình nguyện viên đã [dịch React sang các ngôn ngữ khác](https://translations.react.dev/).

## Lời cảm ơn bổ sung {/*additional-thanks*/}

Ngoài ra, chúng tôi cũng xin cảm ơn:
